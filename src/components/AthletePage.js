'use strict';
//import different components to fill site
...
export default class AthletePage extends React.Component {
  render() {
    ...
    );//display the athlete page integrating other components. access the id with this.props.params.id allowing to propagate routing parameters into components.
  }//redner
}//create athletePage Component
